...
module.exports = {
    loadConfiguration: function(configuration) {
        let data = Buffer.from(configuration, "base64");
    ...
    setUserAgent: function(page, conf) {
        let user_agent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) HeadlessChrome/77.0.3835.0 Safari/537.36 Hebex/netsniff";
